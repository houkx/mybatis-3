...
public class StaticSqlSource implements SqlSource {
  ...
  public StaticSqlSource(Configuration configuration, String sql, List<ParameterMapping> parameterMappings) {
	...
	private void trySqlEnhance(Configuration configuration, String sql, List<ParameterMapping> parameterMappings){
		if (parameterMappings != null && parameterMappings.size() > 0) {
            ...
            if ("select".equals(type)) {
                ...
                tryHandleInsertWithABeanParameter(sql, configuration.isMapUnderscoreToCamelCase(), parameterMappings);
            }
        }
	}
    /**
     ...
     */
    private void tryHandleInsertWithABeanParameter(String sql, boolean isMapUnderscoreToCamelCase, List<ParameterMapping> parameterMappings) {
